...
//		return strArr;
	...
	public GuestVO ajaxTest3_1POST(String name) {
//		GuestVO vo = studyService.getGuestName(name);	
//		return vo;
		return studyService.getGuestName(name);
	}
	// DB를 활용한 값의 전달2(vos)
	@ResponseBody
	@RequestMapping(value = "/ajax/ajaxTest3_2", method = RequestMethod.POST)
	
	public ArrayList<GuestVO> ajaxTest3_2POST(String name) {

//		ArrayList<GuestVO> vos = studyservice.getGuestMid(name);
//		return vos;
		return studyService.getGuestNames(name);
	}
...
// 암호화연습폼(bCryptPassword)
	...
	public String mailFormPost(MailVO vo, HttpServletRequest request) {
		try {
			...
			content += "<p>방문하기 : <a href='http://49.142.157.251:9090/green2209J_13/'>Statiz</a></p>";
			content += "<hr>";
			...
			file = new FileSystemResource("D:\\JavaWorkspace\\springframework\\works\\javawspring\\src\\main\\webapp\\resources\\images\\statiz.zip");
			messageHelper.addAttachment("statiz.zip", file);
